...
def tts_male(text: str,
    ...
    return tts(text, "tts_models/en/vctk/vits",
               speaker='p330', speaker_wav=None, language=None, device=device, out_path=out_path)
...
def tts_female(text: str,
    ...
    return tts(text, "tts_models/en/vctk/vits",
               speaker='p225', speaker_wav=None, language=None, device=device, out_path=out_path)
